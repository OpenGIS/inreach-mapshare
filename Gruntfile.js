module.exports = function (grunt) {
	...
	var joe_files = grunt.file.expand({ filter: "isFile", cwd: joe_inc_path }, [
		"*.php",
	]);
	var app_files = grunt.file.expand({ filter: "isFile", cwd: app_path }, [
		"*.php",
	]);
	...
	for (i in joe_files) {
		...
		var joe_class_new =
			"Joe_v" + package_json.version.replace(".", "_") + "_" + class_name;
	...
	grunt.registerTask("build_wp_js", ["terser:wp_js"]);
