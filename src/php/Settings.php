				...
				'request' => [
					...
					'fields' => [
						'cache_minutes' => [
							...
							'tip' => esc_attr__('How long to Cache responses from Garmin for. Longer Cache times will improve load performance, but will delay updates.', InMap_Config::get_item('plugin_text_domain')),
							'append' => esc_attr__('minutes', InMap_Config::get_item('plugin_text_domain')),
						],
					],
				],
				...
				'response' => [
					...
					'fields' => [
						'precision' => [
							...
							'type' => 'select',
							'options' => [
								'6' => esc_html__('High (up to 10cm!!!)', InMap_Config::get_item('plugin_text_domain')),
								'3' => esc_html__('Medium (up to 100m)', InMap_Config::get_item('plugin_text_domain')),
								'2' => esc_html__('Low (up to 1km)', InMap_Config::get_item('plugin_text_domain')),
							],
